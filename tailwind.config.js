  ...
  theme: {
    ...
    extend: {
      ...
      fontFamily: {
        ...
        // NOTE: Space Grotesk stands in for the licensed Aeonik Pro
        // (design.md's original spec). Swap back to "Aeonik Pro" here
        // — and re-add its @font-face rules in index.css — if you
        // license the real face later.
